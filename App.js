...
function App(){
    ...
    <CartProvider>
      <NavigationContainer>
        <Stack.Navigator>
          ...
          ({title: 'Search', headerRight: () => <CartIcon navigation={navigation} />})} />
  ...
  ) // wrap NavigationContainer with CartProvider
} // coz responsible for managing your app state and linking your top-level navigator to the app environment
